...
Mirrors ``R/espn_nba_01_pbp_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_nba_01_pbp_creation.R``.

Equivalent to::

    python -m nba_data_build --dataset pbp -s <start> -e <end>
"""
