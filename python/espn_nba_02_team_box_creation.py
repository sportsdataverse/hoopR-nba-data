...
Mirrors ``R/espn_nba_02_team_box_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_nba_02_team_box_creation.R``.

Equivalent to::

    python -m nba_data_build --dataset team_box -s <start> -e <end>
"""
