...
Mirrors ``R/espn_nba_07_standings_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_nba_07_standings_creation.R``.

Equivalent to::

    python -m nba_data_build --dataset standings -s <start> -e <end>
"""
