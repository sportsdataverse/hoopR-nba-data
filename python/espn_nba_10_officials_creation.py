...
Mirrors ``R/espn_nba_10_officials_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_nba_10_officials_creation.R``.

Equivalent to::

    python -m nba_data_build --dataset officials -s <start> -e <end>
"""
